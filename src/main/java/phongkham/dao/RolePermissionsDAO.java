...
public class RolePermissionsDAO {
    ...
    public boolean insert(RolePermissionsDTO rolePermissions) {
        String sql = "INSERT INTO RolePermissions (MaRole, MaPermission, MoTa, Active) VALUES (?, ?, ?, ?)";
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            System.err.println("✗ Error inserting RolePermissions: " + e.getMessage());
            return false;
        }
    }
    ...
    public boolean update(RolePermissionsDTO rolePermissions) {
        String sql = "UPDATE RolePermissions SET MaRole = ?, MaPermission = ?, MoTa = ?, Active = ? WHERE MaRolePermissions = ?";
    ...
    public RolePermissionsDTO getById(int maRolePermissions) {
        String sql = "SELECT rp.*, r.TenRole, p.TenPermission " +
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            System.err.println("✗ Error getting RolePermissions by ID: " + e.getMessage());
        }
        return null;
    }
    ...
    public List<RolePermissionsDTO> getAll() {
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            System.err.println("✗ Error getting all RolePermissions: " + e.getMessage());
        }
        return list;
    }
    ...
    public List<RolePermissionsDTO> getByRole(int maRole) {
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            System.err.println("✗ Error getting RolePermissions by Role: " + e.getMessage());
        }
        return list;
    }
    ...
    public boolean hasPermission(int maRole, int maPermission) {
        String sql = "SELECT COUNT(*) FROM RolePermissions WHERE MaRole = ? AND MaPermission = ? AND Active = 1";
    ...
    private RolePermissionsDTO mapResultSetToDTO(ResultSet rs) throws SQLException {
